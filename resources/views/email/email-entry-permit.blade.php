...
<body>
    <div class="card">
        ...
        <h3 class="title-card" style="text-align: center">
            Hello {{ \Illuminate\Support\Str::of($data['name'])->words(1, '') }}, Surat Izin Masuk Kawasan Telah Kami Proses
        </h3>

        <hr class="garis">

        <p class="card-content">
            Selamat, Surat Izin Masuk Kawasan Anda Telah Kami Proses <br>
