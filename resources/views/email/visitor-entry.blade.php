...
<body>
    <div class="card">
        ...
        <h3 class="title-card" style="text-align: center">
            Hello {{ \Illuminate\Support\Str::of($data['name'])->words(1, '') }}, Ada Pengunjung Yang Masuk Kawasan
        </h3>

        <hr class="garis">

        <p class="card-content">
            Hello {{ \Illuminate\Support\Str::of($data['name'])->words(1, '') }}, Ada Pengunjung Yang Baru Masuk Kawasan<br>
