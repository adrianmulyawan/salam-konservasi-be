            ...
            <div class="dashboard-content">
                ...
                <div class="card card-conservation card-detail-transaction">
                    ...
                    <div class="row form-group data-approval">
                        ...
                        <textarea class="form-control mt-3" name="alasan_penolakan" id="alasanPenolakan" rows="3" value="#" disabled>
                    ...
                    <div class="row justify-content-end mr-1 mt-2">
                        <a href="{{ route('submission') }}" class="btn btn-primary py-2 mr-2 px-3">Lakukan Pengajuan Ulang</a>
