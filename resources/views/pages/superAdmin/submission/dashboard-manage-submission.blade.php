...
@section('title', 'Dashboard Kelola Pengajuan')
            ...
            <div class="dashboard-content">
                ...
                <div class="card card-conservation">
                    ...
                    <ul class="nav nav-pills mb-2" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="pills-disetujui-tab" data-toggle="pill" href="#pills-disetujui" role="tab" aria-selected="false">
                                Disetujui
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="pills-ditolak-tab" data-toggle="pill" href="#pills-ditolak" role="tab" aria-selected="false">
                                Ditolak
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="pills-gagal-tab" data-toggle="pill" href="#pills-gagal" role="tab" aria-selected="false">
                                Gagal
                            </a>
                        </li>
                    </ul>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php $counter = 0; ?>
                                                @forelse ($submissionPendings as $pending)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            {{ \Carbon\Carbon::create($pending->date_of_entry)->format('d F, Y') }}
                                                        </td>
                                                        <td class="text-center">
                                                            <a href="{{ route('AdminchangeSubmissionStatus', $pending->id) }}" class="btn btn-info mt-auto">
                                                                <i class="far fa-edit"></i>
                                                            </a>
                                                            <form action="{{ route('AdmindeleteSubmission', $pending->id) }}" method="post" class="d-inline confirm-delete">
                                                                @csrf
                                                                @method('DELETE')
                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($submissionApproved as $approved)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            {{ \Carbon\Carbon::create($approved->date_of_entry)->format('d F, Y') }}
                                                        </td>
                                                        <td class="text-center">
                                                            <a href="{{ route('AdminsubmissionStatusApproved', $approved->id) }}" class="btn btn-info mt-auto">
                                                                <i class="far fa-eye"></i>
                                                            </a>
                                                            <form action="{{ route('AdmindeleteSubmission', $approved->id) }}" method="post" class="d-inline confirm-delete">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button class="btn btn-danger" type="submit">
                                                                    <i class="fa fa-trash"></i>
                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($submissionRejected as $reject)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            {{ \Carbon\Carbon::create($reject->date_of_entry)->format('d F, Y') }}
                                                        </td>
                                                        <td class="text-center">
                                                            <a href="{{ route('AdminsubmissionStatusRejected', $reject->id) }}" class="btn btn-info mt-auto">
                                                                <i class="far fa-eye"></i>
                                                            </a>
                                                            <form action="{{ route('AdmindeleteSubmission', $reject->id) }}" method="post" class="d-inline confirm-delete">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button class="btn btn-danger" type="submit">
                                                                    <i class="fa fa-trash"></i>
                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($submissionFailed as $failed)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            {{ \Carbon\Carbon::create($failed->date_of_entry)->format('d F, Y') }}
                                                        </td>
                                                        <td class="text-center">
                                                            <a href="{{ route('AdminsubmissionStatusFailed', $failed->id) }}" class="btn btn-info mt-auto">
                                                                <i class="far fa-eye"></i>
                                                            </a>
                                                            <form action="{{ route('AdmindeleteSubmission', $failed->id) }}" method="post" class="d-inline confirm-delete">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button class="btn btn-danger" type="submit">
                                                                    <i class="fa fa-trash"></i>
