        ...
        <div class="container-fluid">
            ...
            <div class="dashboard-content">
                ...
                <div class="card card-conservation card-detail-transaction">
                    ...
                    <!-- 2.4 Rekening -->
                    <div class="row form-group data-pemilik-rekening mt-1">
                        <h5>Nama Rekening Pembayaran</h5>
                        <input class="form-control mt-2" id="disabledInput" type="text" name="nama_pemilik_rekening" value="Adrian Mulyawan" disabled>
                    </div>

                    <!-- 2.5 Bukti Transfer -->
                    <div class="row data-bukti-transfer">
                    ...
                    <div class="row form-group data-approval mt-4">
                        ...
                        <select class="form-control mt-2" id="inputApproval">
