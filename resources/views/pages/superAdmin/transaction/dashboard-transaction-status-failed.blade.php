...
@section('title', 'Detail Pembayaran: Gagal')
            ...
            <div class="dashboard-content">
                ...
                <div class="card card-conservation card-detail-transaction">
                    ...
                    <div class="form-group data-approval mt-2">
                        ...
                        <input class="form-control mt-2" id="disabledInput" type="text" name="payment_status" value="{{ $item->payment_status == "FAILED" ? 'GAGAL' : '' }}" disabled>
                    </div>
