            ...
            <div class="dashboard-content">
                ...
                <div class="card card-conservation card-detail-transaction">
                    ...
                    <div class="row form-group data-approval mt-4">
                        ...
                        <input class="form-control mt-2" id="disabledInput" type="text" name="status_pembayaran" value="Ditolak" disabled>
                    </div>
                    
                    <!-- 2.6 Alasan Ditolak -->
                    <div class="row form-group data-approval mt-4">
                        <h5>Alasan Pengajuan Ditolak</h5>
                        <input class="form-control mt-2" id="disabledInput" type="text" name="status_pembayaran" value="Data yang anda masukan tidak valid" disabled>
                    </div>

                    <!-- 2.7 Button Close -->
                    <div class="row justify-content-end mt-4 mr-0">
