        ...
        <div class="container-fluid">
            ...
            <div class="dashboard-content">
                ...
                <div class="card card-conservation card-detail-transaction">
                    ...
                    <!-- 2.4 Tanggal Masuk -->
                    <div class="form-group data-approval">
                        <h5>Tanggal Masuk Kawasan</h5>
                        <input class="form-control mt-2" id="disabledInput" type="text" name="date_of_entry_area" value="{{ isset($data->visitor_control->date_of_entry_area) ? \Carbon\Carbon::create($data->visitor_control->date_of_entry_area)->format('d F Y') : 'Pengunjung Belum Masuk Kawasan' }}" disabled>
                    </div>

                    <!-- 2.5 Tanggal Keluar -->
                    <div class="form-group data-approval mt-2">
                        <h5>Tanggal Keluar Kawasan</h5>
                        <input class="form-control mt-2" id="disabledInput" type="text" name="out_date_area" value="{{ isset($data->visitor_control->out_date_area) ? \Carbon\Carbon::create($data->visitor_control->out_date_area)->format('d F Y') : 'Pengunjung Belum Keluar Kawasan' }}" disabled>
                    </div>
