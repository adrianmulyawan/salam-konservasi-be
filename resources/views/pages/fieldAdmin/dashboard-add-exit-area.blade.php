        ...
        <div class="container-fluid">
            ...
            <div class="dashboard-content">
                ...
                <div class="card card-conservation card-detail-transaction">
                    ...
                    <form action="{{ route('storeExit', $data->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <!-- 2.4 Tanggal Keluar -->
                        <div class="form-group data-approval">
                            <h5>Tanggal Keluar Kawasan</h5>
                            <input type="text" class="form-control datepicker" id="tanggal_keluar" name="out_date_area" required placeholder="Tanggal Keluar Kawasan">
                        </div>
